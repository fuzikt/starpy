...
class RotateParticlesStar():
    def define_parser(self):
        self.parser = argparse.ArgumentParser(
            description="Perform rotation of particles according to given euler angles. \n Example: rotate_particles_star.py --i input.star --o output.star --rot 15 --tilt 20 --psi 150", formatter_class=RawTextHelpFormatter)
    ...
    def rotateParticles(self, particles, rot, tilt, psi, x, y, z):
        ...
        for particle in copy.deepcopy(particles):
            matrix_particle = matrix_from_euler(radians(particle.rlnAngleRot), radians(particle.rlnAngleTilt), radians(particle.rlnAnglePsi))
    ...
    def main(self):
        ...
        print "Performing rootation of particles from star file..."
