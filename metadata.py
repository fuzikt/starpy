...
LABELS = {
    ...
    'rlnAnglePsiFlipRatio': float, #Flip ratio of bimodal psi prior': 0~0.5, 0 means an ordinary prior, 0.5 means a perfect bimodal prior)
    ...
    'rlnAngleRotFlipRatio': float, #Flip ratio of bimodal rot prior': 0~0.5, 0 means an ordinary prior, 0.5 means a perfect bimodal prior)
    ...
    'rlnDoExternalReconstruct': bool, #Flag to indicate that the reconstruction will be performed outside relion_refine, e.g. for learned priors
    ...
    'rlnDoStochasticEM': bool, #Flag to indicate that stochastic EM-optimisation should be performed': an alternative to SGD)
    ...
    'rlnEvenZernike': vector<float>, #Coefficients for the symmetrical Zernike polynomials
    ...
    'rlnFourierShellCorrelationParticleMaskFraction': float, #CisTEM-like correction of unmasked FSCs, based on fraction of white pixels in solvent mask
    'rlnFourierShellCorrelationParticleMolWeight': float, #CisTEM-like correction of unmasked FSCs, based on ordered molecular weight estimate
    ...
    'rlnHealpixOrderOriginal': int, #Original healpix order for the sampling of the first two Euler angles': rot, tilt) on the 3D sphere
    ...
    'rlnOddZernike': vector<float>, #Coefficients for the antisymmetrical Zernike polynomials
    ...
    'rlnOutputRootName': str, #Rootname for all output files': this may include a directory structure, which should then exist)
    ...
    'rlnParticleBoxFractionMolecularWeight': float, #Fraction of protein voxels in the box, based on ordered molecular weight estimate, for calculating cisTEM-like part_FSC
    'rlnParticleBoxFractionSolventMask': float, #Fraction of protein voxels in the box, based on the solvent mask, for calculating cisTEM-like part_FSC
    ...
    'rlnScheduleEdgeIsFork': bool, #Flag to indicate that this Edge is a Fork, dependent on a Boolean Schedule variable
    ...
    'rlnScheduleEdgeOutputNodeNameIfTrue': str, #Name of the output Node for a schedule Fork if the associated Boolean is True
    ...
    'rlnScheduleJobHasStarted': bool, #Flag to indicate whether a Job has started already in the execution of the Schedule
    ...
    'rlnSgdSigma2FudgeInitial': float, #The variance of the noise will initially be multiplied with this value': larger than 1)
    ...
    'rlnSolventMaskName': str, #Name of an image that contains a': possibly soft) mask for the solvent area': values=0 for solvent, values =1 for protein)
    ...
    'rlnTiltAngleLimit': float, #Values to which to limit the tilt angles': positive for keeping side views, negative for keeping top views)
