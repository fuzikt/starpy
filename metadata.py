...
LABELS = {
    ...
    'rlnHelicalTrackLength': float, #Distance from the position of this helical segment to the starting point of the tube
    ...
    'rlnOriginYPrior': float, #Center of the prior on the X-coordinate (in pixels) for the origin of rotation
    'rlnOriginZ': float, #Z-coordinate (in pixels) for the origin of rotation
    'rlnOriginZPrior': float, #Center of the prior on the X-coordinate (in pixels) for the origin of rotation
    ...
    'rlnSigmaOffsets': float, #Standard deviation in the origin offsets (in Angstroms)
